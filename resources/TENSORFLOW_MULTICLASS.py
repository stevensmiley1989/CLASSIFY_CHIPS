...
if os.path.exists(SETTINGS_PATH):
    ...
    from tmp.CUSTOM_SETTINGS import PORT,HOST,target,ignore_list_str,chipW,chipH,batch_size,custom_model_path,custom_model_path,classes_path,data_dir,LOAD_PREVIOUS,data_dir_test,data_dir_train
